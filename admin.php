    ...
    <div class="d-flex flex-column">
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="#about" class="nav-link scrollto"><i class="bx bx-file-blank"></i> <span>Anasayfa Veri Ekle</span></a></li>
          <li><a href="production/hakkimizda-veri.php" class="nav-link scrollto"><i class="bx bx-file-blank"></i> <span>Hakkımızda Veri Ekle</span></a></li>
          <li><a href="production/iletisim-veri.php" class="nav-link scrollto"><i class="bx bx-file-blank"></i> <span>İletişim Veri Ekle</span></a></li>
          <li><a href="production/slider.php" class="nav-link scrollto"><i class="bx bx-book-content"></i> <span>Sliderlar</span></a></li>
          <li><a href="production/menu.php" class="nav-link scrollto"><i class="bx bx-envelope"></i> <span>Menü Değiştir</span></a></li>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Veri Ekle</h2>
          <p>Siteye veri girişini buradan yapabilirsiniz!</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4" data-aos="fade-right">
            ...
            <br><br><br>
            <p style="font-style:italic ;">Resim Yükleme:</p>
...
<?php $messages[0]="Resim başarıyla yüklendi!";   
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <script src="ck/ckeditor/ckeditor.js"></script>
              <textarea class="ckeditor" id="ckeditor1" name="icerik"><?= $sonuc["icerik"] ?></textarea>
              <br>
              <script>
                CKEDITOR.replace( 'ckeditor1', {
    filebrowserBrowseUrl: 'ck/ckfinder/ckfinder.html',
    filebrowserImageBrowseUrl: 'ck/ckfinder/ckfinder.html?type=Flash',
