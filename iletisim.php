            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="row">
                        <?php $resimler = $baglan->prepare("SELECT * FROM iletisimresimyukleme");
                                $resimler->execute();
                                if ($resimler->rowCount()) {
                                    foreach ($resimler as $row) {      ?> <img src="9 mart web/<?php echo $row["resim"]; ?>" width="%50" height="50%" alt="resim" /> <?php }
                                                                                                                                                                } ?>
                        </div>
                    </div>
