...
$sorgu = $baglan->prepare("SELECT * FROM veri_iletisim Where id=1");
$sorgu->execute();
$sonuc = $sorgu->fetch();
...
if ($_POST) {
  ...
  $sql = "UPDATE veri_iletisim SET icerik=:icerik WHERE id=1;";
  $durum = $baglan->prepare($sql)->execute($satir);
  if ($durum == true) {
    header('location: iletisim-veri.php');
  }
}
?>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h2>İletişim Sayfasına Veri Ekle</h2>
          <p>İletişim sayfasına veri girişini buradan yapabilirsiniz!</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            <form action="" method="POST">
              <script src="../ck/ckeditor/ckeditor/ckeditor.js"></script>
              <textarea class="ckeditor" id="ckeditor3" name="icerik"><?= $sonuc["icerik"] ?></textarea>
              <br>
              <script>
            ...
            <form action="uploadiletisim.php" method="post" name="form1" enctype="multipart/form-data">
